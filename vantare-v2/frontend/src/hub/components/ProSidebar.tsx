export function ProSidebar() {
  return (
    <>
      {/* Vantare Pro Promo */}
      <div className="relative rounded-xl overflow-hidden group cursor-pointer border border-vantare-red-900/50 hover:border-vantare-red-500/50 transition-all hover:-translate-y-1">
        <div className="absolute inset-0 bg-gradient-to-br from-vantare-red-900/60 via-vantare-burgundy/40 to-vantare-bg" />
        <div className="absolute right-0 top-0 w-32 h-32 bg-vantare-red-500/20 blur-3xl rounded-full group-hover:bg-vantare-red-400/30 transition-all" />
      ...
      <div className="glass-panel rounded-xl p-6 border border-white/5 relative overflow-hidden flex-1">
        <div className="absolute top-0 right-0 w-40 h-40 bg-vantare-wine/10 blur-3xl rounded-full pointer-events-none" />
        ...
        <div className="space-y-4">
          <div className="group flex flex-col gap-3 p-4 rounded-xl bg-vantare-surface border border-white/5 hover:border-vantare-red-900/50 hover:bg-gradient-to-br hover:from-vantare-surface hover:to-vantare-red-950/20 transition-all cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-vantare-red-700 to-vantare-burgundy flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform">
          ...
          <div className="group flex flex-col gap-3 p-4 rounded-xl bg-vantare-surface border border-white/5 hover:border-indigo-900/50 hover:bg-gradient-to-br hover:from-vantare-surface hover:to-indigo-950/20 transition-all cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-600 to-vantare-bg flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
