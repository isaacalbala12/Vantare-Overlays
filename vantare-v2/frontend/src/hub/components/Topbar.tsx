      ...
      <div className="max-w-[1920px] mx-auto px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-3">
            <svg className="w-8 h-8" viewBox="0 0 40 40" fill="none" style={{ filter: "drop-shadow(0 0 10px rgba(139, 0, 0, 0.6))" }}>
              <defs>
              ...
              <path d="M20 2 L38 38 L28 38 L20 18 L12 38 L2 38 Z" fill="url(#logoGradTop)" stroke="rgba(255,255,255,0.2)" strokeWidth="0.5" />
              <path d="M20 8 L32 34 L26 34 L20 20 L14 34 L8 34 Z" fill="none" stroke="rgba(255,255,255,0.1)" strokeWidth="0.5" />
            </svg>
            <span className="font-display font-bold text-xl tracking-wider text-white">VANTARE</span>
          </div>
